...
def get_input_args():
    ...
    argparse module to create and defined these 3 command line arguments. If 
    ...
    # 3 command line arguments  mentioned above using add_argument() from ArguementParser method
    #Image Folder Argument 
    parser.add_argument('--dir', type=str, default='data/pet_images', 
                        help='Path to the folder of pet images')
    
    # CNN model Architecture argument 
    parser.add_argument('--arch', type=str, default='vgg', 
                        help='CNN model architecture to use')
    
    # Dog Names Text File Arguments
